...
export async function buildSystemContext(
  ...
  if (skillIndex) {
    parts.push(
      "<!-- Available Skills — This index includes only skill names and descriptions. When a task matches a description, use read_skill with the skill name before applying it. -->",
      skillIndex,
    );
  }
